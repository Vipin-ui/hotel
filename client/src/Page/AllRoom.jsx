  ...
  const [searchParams,setSearchParams]=useSearchParams();
    ...
    const handleFilterChange =(checked,value,type)=>{
      setSelectedFilters((prevFilters)=>{
        ...
        if(checked){
          const exists = updatedFilters[type].includes(value);
          updatedFilters[type] = exists
            ? updatedFilters[type]
    ...
    const filterDestination =(room)=>{
      ...
      const name = room.hotel.name || '';
      return city.toLowerCase().includes(destination.toLowerCase()) || name.toLowerCase().includes(destination.toLowerCase());    
    }
            ...
            room && room.hotel && (
              ...
              >
                <img
                  ...
                  src={room?.images?.[0] || 'https://via.placeholder.com/800x500?text=Room+Image'}
                  alt="hotel-img"
                ...
                <div className="md:w-1/2 flex flex-col gap-2">
                  ...
                  <p className="text-xl font-medium text-gray-700">
                    {currency} {room.pricePerNight || 0}/night
                  </p>
                </div>
              </div>
            )
